  ...
  return (
    <AppLayout>
      ...
      <button
        ...
        className="fixed top-20 right-4 z-[1000] inline-flex items-center gap-1.5 px-3 py-2 rounded-lg text-sm font-medium text-foreground hover:text-gold transition-colors"
        aria-label="Go back"
      >
        <span
